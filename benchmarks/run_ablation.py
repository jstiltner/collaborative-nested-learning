...
def run_ablation(config: Optional[ExperimentConfig] = None) -> Dict[str, Any]:
    ...
    for opt_name, results in all_results.items():
        ...
        print(f"{opt_name:<25} | {metrics['average_accuracy']:>8.4f} | "
    ...
    print(f"\nImprovement:")
    print(f"  Forgetting reduction: {forgetting_improvement:.4f} ({forgetting_improvement/nested_forgetting*100:.1f}%)")
    print(f"  Accuracy improvement: {acc_improvement:.4f} ({acc_improvement/nested_acc*100:.1f}%)")
